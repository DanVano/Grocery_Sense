...
public sealed class FlyerDocIntClient : IFlyerLayoutClient
{
        ...
        string filePath, CancellationToken ct = default)
    {
        ...
        // from the disposed doc). Avoids reflection-based Deserialize<Dictionary<string,object?>>, unsafe under
        // iOS full AOT (B1). Same shape FlyerIngestService navigates.
